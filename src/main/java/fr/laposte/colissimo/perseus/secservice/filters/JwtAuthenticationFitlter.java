...
public class JwtAuthenticationFitlter extends UsernamePasswordAuthenticationFilter {

	private AuthenticationManager authenticationManager;

	public JwtAuthenticationFitlter(AuthenticationManager authenticationManager) {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		System.out.println("success auhtentification");
